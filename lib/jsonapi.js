...
import { getGraphPersonUuid } from './user-graph';
...
async function basketJsonApi( basketUri, graph ) {
  ...
  const customerUuid = await getGraphPersonUuid( graph );
    ...
    data: [{
      ...
      relationships: {
        ...
        "customer": {
          links: {}, // None available
          data: {
            type: "people", // we exect this to have been fetched during login
            id: customerUuid ? customerUuid : null
          }
        }
      }
    }],
